    ...
    <>
      <div className="space-y-2">
        <button
          ...
          className="group relative block h-40 w-full overflow-hidden rounded-lg bg-gray-100 md:h-48"
        ...
        >
          ...
          />
          <span className="absolute bottom-2 right-2 inline-flex items-center gap-1 rounded-full bg-black/60 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur transition-colors group-hover:bg-black/80">
